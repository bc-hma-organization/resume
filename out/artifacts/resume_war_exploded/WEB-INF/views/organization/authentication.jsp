...
<div class="big_box">
    ...
    <div class="box_main">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <span>性别：</span>
                            <span>
                                        <c:if test="${!userInfo.sex}">男</c:if>
                                        <c:if test="${userInfo.sex}">女</c:if>
                                    </span>
                        </td>
                        <td>
                            <span>年龄：</span>
        ...
        <div class="main_botom">
            <c:if test="${not empty infoList.get(0).education}">
                <div class="title_box">
                    <p>学习经历：</p>
                </div>
                <div class="table_box">
            ...
            <c:if test="${empty infoList.get(0).education}">
                <div class="title_box">
                    <p>工作经历：</p>
                </div>
                <div class="table_box">
...
<script>
    ...
    function sub(status) {
        ...
        $.ajax({
            ...
            data: {'infoIds': ids,'status': status, 'userId':userId},
            async: false,
            success : function (re) {
                if(re.success){
